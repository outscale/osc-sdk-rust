...
*AccountApi* | [**read_co2_emission_account**](docs/AccountApi.md#read_co2_emission_account) | **POST** /ReadCO2EmissionAccount | 
...
*IdentityProviderApi* | [**disable_outscale_login**](docs/IdentityProviderApi.md#disable_outscale_login) | **POST** /DisableOutscaleLogin | 
*IdentityProviderApi* | [**disable_outscale_login_for_users**](docs/IdentityProviderApi.md#disable_outscale_login_for_users) | **POST** /DisableOutscaleLoginForUsers | 
*IdentityProviderApi* | [**disable_outscale_login_per_users**](docs/IdentityProviderApi.md#disable_outscale_login_per_users) | **POST** /DisableOutscaleLoginPerUsers | 
*IdentityProviderApi* | [**enable_outscale_login**](docs/IdentityProviderApi.md#enable_outscale_login) | **POST** /EnableOutscaleLogin | 
*IdentityProviderApi* | [**enable_outscale_login_for_users**](docs/IdentityProviderApi.md#enable_outscale_login_for_users) | **POST** /EnableOutscaleLoginForUsers | 
*IdentityProviderApi* | [**enable_outscale_login_per_users**](docs/IdentityProviderApi.md#enable_outscale_login_per_users) | **POST** /EnableOutscaleLoginPerUsers | 
...
*VmApi* | [**read_vms_stop_history**](docs/VmApi.md#read_vms_stop_history) | **POST** /ReadVmsStopHistory | 
...
*VolumeApi* | [**read_volume_update_tasks**](docs/VolumeApi.md#read_volume_update_tasks) | **POST** /ReadVolumeUpdateTasks | Lists one or more update tasks of volumes
