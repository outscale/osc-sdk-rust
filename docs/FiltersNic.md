...
**link_nic_vm_account_ids** | Option<**Vec<String>**> | The OUTSCALE account IDs of the owners of the VMs the NICs are attached to. | [optional]
**link_nic_vm_ids** | Option<**Vec<String>**> | The IDs of the VMs the NICs are attached to. | [optional]
**link_public_ip_account_ids** | Option<**Vec<String>**> | The OUTSCALE account IDs of the owners of the public IPs associated with the NICs. | [optional]
...
**private_ips_link_public_ip_account_ids** | Option<**Vec<String>**> | The OUTSCALE account IDs of the owner of the public IPs associated with the private IPs. | [optional]
