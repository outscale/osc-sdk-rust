...
**ip_ranges** | Option<**Vec<String>**> | One or more IP ranges for the security group rules, in CIDR notation (for example, `[&quot;10.0.0.0/24&quot; , &quot;10.0.1.0/24&quot;]`). | [optional]
**security_group_rule_id** | Option<**String**> | The ID of the security group rule. | [optional]
