...
**inbound_rule_account_ids** | Option<**Vec<String>**> | The OUTSCALE account IDs that have been granted permissions. | [optional]
...
**outbound_rule_account_ids** | Option<**Vec<String>**> | The OUTSCALE account IDs that have been granted permissions. | [optional]
