...
------------ | ------------- | ------------- | -------------
**accepter_net_account_ids** | Option<**Vec<String>**> | The OUTSCALE account IDs of the owners of the peer Nets. | [optional]
...
**source_net_account_ids** | Option<**Vec<String>**> | The OUTSCALE account IDs of the owners of the peer Nets. | [optional]
