...
/// struct for typed errors of method [`read_api_logs`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ReadApiLogsError {
...
pub fn read_api_logs(
    configuration: &configuration::Configuration,
    read_api_logs_request: Option<crate::models::ReadApiLogsRequest>,
) -> Result<crate::models::ReadApiLogsResponse, Error<ReadApiLogsError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/ReadApiLogs", local_var_configuration.base_path);
    ...
    if let Some(ref local_var_aws_v4_key) = local_var_configuration.aws_v4_key {
        let local_var_new_headers = match local_var_aws_v4_key.sign(
            &local_var_uri_str,
            "POST",
            &serde_json::to_string(&read_api_logs_request)
    ...
    local_var_req_builder = local_var_req_builder.json(&read_api_logs_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReadApiLogsError> =
