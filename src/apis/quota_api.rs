...
/// struct for typed errors of method [`read_quotas`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ReadQuotasError {
...
pub fn read_quotas(
    ...
    read_quotas_request: Option<crate::models::ReadQuotasRequest>,
) -> Result<crate::models::ReadQuotasResponse, Error<ReadQuotasError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/ReadQuotas", local_var_configuration.base_path);
    ...
    if let Some(ref local_var_aws_v4_key) = local_var_configuration.aws_v4_key {
        let local_var_new_headers = match local_var_aws_v4_key.sign(
            &local_var_uri_str,
            "POST",
            &serde_json::to_string(&read_quotas_request).expect("param should serialize to string"),
        ) {
    ...
    local_var_req_builder = local_var_req_builder.json(&read_quotas_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReadQuotasError> =
