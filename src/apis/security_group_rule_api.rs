...
pub fn create_security_group_rule(
    ...
    create_security_group_rule_request: Option<crate::models::CreateSecurityGroupRuleRequest>,
) -> Result<crate::models::CreateSecurityGroupRuleResponse, Error<CreateSecurityGroupRuleError>> {
    ...
    if let Some(ref local_var_aws_v4_key) = local_var_configuration.aws_v4_key {
        let local_var_new_headers = match local_var_aws_v4_key.sign(
            &local_var_uri_str,
            "POST",
            &serde_json::to_string(&create_security_group_rule_request)
...
pub fn delete_security_group_rule(
    configuration: &configuration::Configuration,
    delete_security_group_rule_request: Option<crate::models::DeleteSecurityGroupRuleRequest>,
) -> Result<crate::models::DeleteSecurityGroupRuleResponse, Error<DeleteSecurityGroupRuleError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_aws_v4_key) = local_var_configuration.aws_v4_key {
        let local_var_new_headers = match local_var_aws_v4_key.sign(
            &local_var_uri_str,
            "POST",
            &serde_json::to_string(&delete_security_group_rule_request)
                .expect("param should serialize to string"),
        ) {
            Ok(new_headers) => new_headers,
            Err(err) => return Err(Error::AWSV4SignatureError(err)),
    ...
    local_var_req_builder = local_var_req_builder.json(&delete_security_group_rule_request);
