...
pub struct FiltersNatService {
    ...
    #[serde(rename = "NatServiceIds", skip_serializing_if = "Option::is_none")]
    pub nat_service_ids: Option<Vec<String>>,
...
impl FiltersNatService {
    /// One or more filters.
    pub fn new() -> FiltersNatService {
        FiltersNatService {
            client_tokens: None,
            nat_service_ids: None,
            net_ids: None,
            states: None,
            subnet_ids: None,
            tag_keys: None,
