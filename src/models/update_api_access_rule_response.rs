...
pub struct UpdateApiAccessRuleResponse {
    #[serde(rename = "ApiAccessRule", skip_serializing_if = "Option::is_none")]
    pub api_access_rule: Option<Box<crate::models::ApiAccessRule>>,
...
impl UpdateApiAccessRuleResponse {
    pub fn new() -> UpdateApiAccessRuleResponse {
        UpdateApiAccessRuleResponse {
            api_access_rule: None,
