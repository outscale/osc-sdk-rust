...
pub enum SecureBootAction {
    ...
    Disable,
    #[serde(rename = "setup-mode")]
    SetupMode,
    #[serde(rename = "none")]
    None,
    #[serde(rename = "restore-factory-keys")]
    RestoreFactoryKeys,
}

impl ToString for SecureBootAction {
    fn to_string(&self) -> String {
        match self {
            Self::Enable => String::from("enable"),
            Self::Disable => String::from("disable"),
            Self::SetupMode => String::from("setup-mode"),
            Self::None => String::from("none"),
            Self::RestoreFactoryKeys => String::from("restore-factory-keys"),
        }
    }
}

impl Default for SecureBootAction {
    fn default() -> SecureBootAction {
        Self::Enable
    }
}
