...
pub struct UpdateAccessKeyRequest {
    ...
    #[serde(
        rename = "ClearExpirationDate",
        skip_serializing_if = "Option::is_none"
    )]
    pub clear_expiration_date: Option<bool>,
    /// If true, the current tag of the access key is deleted.
    #[serde(rename = "ClearTag", skip_serializing_if = "Option::is_none")]
...
impl UpdateAccessKeyRequest {
    pub fn new(access_key_id: String) -> UpdateAccessKeyRequest {
        UpdateAccessKeyRequest {
            access_key_id,
            clear_expiration_date: None,
            clear_tag: None,
            dry_run: None,
