...
pub struct DeleteLoadBalancerTagsRequest {
    ...
    #[serde(rename = "Tags")]
    pub tags: Vec<crate::models::ResourceLoadBalancerTag>,
}

impl DeleteLoadBalancerTagsRequest {
    pub fn new(
        load_balancer_names: Vec<String>,
        tags: Vec<crate::models::ResourceLoadBalancerTag>,
