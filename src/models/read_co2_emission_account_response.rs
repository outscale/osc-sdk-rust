...
pub struct ReadCo2EmissionAccountResponse {
    /// The CO2 emission by month and account, for the specified request.
    #[serde(rename = "CO2EmissionEntries", skip_serializing_if = "Option::is_none")]
    pub co2_emission_entries: Option<Vec<crate::models::Co2EmissionEntry>>,
...
impl ReadCo2EmissionAccountResponse {
    pub fn new() -> ReadCo2EmissionAccountResponse {
        ReadCo2EmissionAccountResponse {
            co2_emission_entries: None,
