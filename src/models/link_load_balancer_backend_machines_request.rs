...
pub struct LinkLoadBalancerBackendMachinesRequest {
...
impl LinkLoadBalancerBackendMachinesRequest {
    pub fn new(load_balancer_name: String) -> LinkLoadBalancerBackendMachinesRequest {
