...
pub struct UpdateRoutePropagationResponse {
    ...
    pub route_table: Option<Box<crate::models::RouteTable>>,
}

impl UpdateRoutePropagationResponse {
    pub fn new() -> UpdateRoutePropagationResponse {
