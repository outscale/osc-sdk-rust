...
pub struct UpdateVmTemplateRequest {
    ...
    #[serde(rename = "VmTemplateName", skip_serializing_if = "Option::is_none")]
    pub vm_template_name: Option<String>,
}

impl UpdateVmTemplateRequest {
    pub fn new(vm_template_id: String) -> UpdateVmTemplateRequest {
