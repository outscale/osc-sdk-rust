...
pub struct FiltersVmType {
    ...
    #[serde(rename = "EphemeralsTypes", skip_serializing_if = "Option::is_none")]
    pub ephemerals_types: Option<Vec<String>>,
    /// The number of Ethernet interfaces available.
    #[serde(rename = "Eths", skip_serializing_if = "Option::is_none")]
    pub eths: Option<Vec<i32>>,
    /// The number of GPUs available.
    #[serde(rename = "Gpus", skip_serializing_if = "Option::is_none")]
    pub gpus: Option<Vec<i32>>,
