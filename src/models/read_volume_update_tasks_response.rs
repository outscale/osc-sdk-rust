...
pub struct ReadVolumeUpdateTasksResponse {
    ...
    #[serde(rename = "VolumeUpdateTasks", skip_serializing_if = "Option::is_none")]
    pub volume_update_tasks: Option<Vec<crate::models::VolumeUpdateTask>>,
}

impl ReadVolumeUpdateTasksResponse {
    pub fn new() -> ReadVolumeUpdateTasksResponse {
        ReadVolumeUpdateTasksResponse {
            next_page_token: None,
            response_context: None,
            volume_update_tasks: None,
        }
    }
}
