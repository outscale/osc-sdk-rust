...
pub struct ReadManagedPoliciesLinkedToUserGroupResponse {
    ...
    #[serde(rename = "MaxResultsLimit", skip_serializing_if = "Option::is_none")]
    pub max_results_limit: Option<i32>,
    /// If true, indicates whether requested page size is more than allowed.
    #[serde(
        rename = "MaxResultsTruncated",
        skip_serializing_if = "Option::is_none"
    )]
    pub max_results_truncated: Option<bool>,
    /// A list of policies.
    #[serde(rename = "Policies", skip_serializing_if = "Option::is_none")]
    pub policies: Option<Vec<crate::models::LinkedPolicy>>,
...
impl ReadManagedPoliciesLinkedToUserGroupResponse {
    pub fn new() -> ReadManagedPoliciesLinkedToUserGroupResponse {
        ReadManagedPoliciesLinkedToUserGroupResponse {
            has_more_items: None,
            max_results_limit: None,
            max_results_truncated: None,
            policies: None,
