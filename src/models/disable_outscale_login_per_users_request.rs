...
pub struct DisableOutscaleLoginPerUsersRequest {
...
impl DisableOutscaleLoginPerUsersRequest {
    pub fn new(user_names: Vec<String>) -> DisableOutscaleLoginPerUsersRequest {
