...
pub struct ReadDirectLinkInterfacesResponse {
    /// Information about one or more DirectLink interfaces.
    #[serde(
        rename = "DirectLinkInterfaces",
        skip_serializing_if = "Option::is_none"
    )]
    pub direct_link_interfaces: Option<Vec<crate::models::DirectLinkInterfaces>>,
...
impl ReadDirectLinkInterfacesResponse {
    pub fn new() -> ReadDirectLinkInterfacesResponse {
        ReadDirectLinkInterfacesResponse {
            direct_link_interfaces: None,
