...
pub struct LinkManagedPolicyToUserGroupRequest {
...
impl LinkManagedPolicyToUserGroupRequest {
    pub fn new(policy_orn: String, user_group_name: String) -> LinkManagedPolicyToUserGroupRequest {
