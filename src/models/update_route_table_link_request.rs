...
pub struct UpdateRouteTableLinkRequest {
...
impl UpdateRouteTableLinkRequest {
    pub fn new(link_route_table_id: String, route_table_id: String) -> UpdateRouteTableLinkRequest {
