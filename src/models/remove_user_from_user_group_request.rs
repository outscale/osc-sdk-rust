...
pub struct RemoveUserFromUserGroupRequest {
    ...
    #[serde(rename = "UserGroupName")]
    pub user_group_name: String,
    /// The path to the group. If not specified, it is set to a slash (`/`).
    #[serde(rename = "UserGroupPath", skip_serializing_if = "Option::is_none")]
    pub user_group_path: Option<String>,
    /// The name of the user you want to remove from the group.
    #[serde(rename = "UserName")]
    pub user_name: String,
    /// The path to the user (by default, `/`).
    #[serde(rename = "UserPath", skip_serializing_if = "Option::is_none")]
    pub user_path: Option<String>,
}

impl RemoveUserFromUserGroupRequest {
    pub fn new(user_group_name: String, user_name: String) -> RemoveUserFromUserGroupRequest {
        RemoveUserFromUserGroupRequest {
            dry_run: None,
            user_group_name,
            user_group_path: None,
            user_name,
            user_path: None,
        }
    }
