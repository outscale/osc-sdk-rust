...
pub struct DeleteUserGroupPolicyRequest {
...
impl DeleteUserGroupPolicyRequest {
    pub fn new(policy_name: String, user_group_name: String) -> DeleteUserGroupPolicyRequest {
