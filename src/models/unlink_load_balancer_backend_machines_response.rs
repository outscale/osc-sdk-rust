...
pub struct UnlinkLoadBalancerBackendMachinesResponse {
...
impl UnlinkLoadBalancerBackendMachinesResponse {
    pub fn new() -> UnlinkLoadBalancerBackendMachinesResponse {
