...
pub struct ReadUserGroupPoliciesResponse {
    ...
    pub policies: Option<Vec<crate::models::InlinePolicy>>,
...
impl ReadUserGroupPoliciesResponse {
    pub fn new() -> ReadUserGroupPoliciesResponse {
