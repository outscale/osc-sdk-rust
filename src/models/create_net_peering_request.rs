...
pub struct CreateNetPeeringRequest {
    ...
    #[serde(rename = "AccepterNetId")]
    pub accepter_net_id: String,
    ...
    #[serde(rename = "AccepterOwnerId", skip_serializing_if = "Option::is_none")]
    pub accepter_owner_id: Option<String>,
    /// If true, checks whether you have the required permissions to perform the action.
    #[serde(rename = "DryRun", skip_serializing_if = "Option::is_none")]
    pub dry_run: Option<bool>,
    /// The ID of the Net you send the peering request from.
    #[serde(rename = "SourceNetId")]
    pub source_net_id: String,
}

impl CreateNetPeeringRequest {
    pub fn new(accepter_net_id: String, source_net_id: String) -> CreateNetPeeringRequest {
