...
pub struct ReadPolicyVersionsResponse {
    ...
    #[serde(rename = "PolicyVersions", skip_serializing_if = "Option::is_none")]
    pub policy_versions: Option<Vec<crate::models::PolicyVersion>>,
...
impl ReadPolicyVersionsResponse {
    pub fn new() -> ReadPolicyVersionsResponse {
