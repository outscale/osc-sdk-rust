...
pub struct ReadLoadBalancerTagsResponse {
    ...
    pub tags: Option<Vec<crate::models::LoadBalancerTag>>,
}

impl ReadLoadBalancerTagsResponse {
    pub fn new() -> ReadLoadBalancerTagsResponse {
