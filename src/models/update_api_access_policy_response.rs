...
pub struct UpdateApiAccessPolicyResponse {
    #[serde(rename = "ApiAccessPolicy", skip_serializing_if = "Option::is_none")]
    pub api_access_policy: Option<Box<crate::models::ApiAccessPolicy>>,
...
impl UpdateApiAccessPolicyResponse {
    pub fn new() -> UpdateApiAccessPolicyResponse {
        UpdateApiAccessPolicyResponse {
            api_access_policy: None,
