...
pub struct ReadUserGroupPolicyResponse {
    #[serde(rename = "Policy", skip_serializing_if = "Option::is_none")]
    pub policy: Option<Box<crate::models::InlinePolicy>>,
...
impl ReadUserGroupPolicyResponse {
    pub fn new() -> ReadUserGroupPolicyResponse {
