...
pub struct DeleteDirectLinkInterfaceRequest {
...
impl DeleteDirectLinkInterfaceRequest {
    pub fn new(direct_link_interface_id: String) -> DeleteDirectLinkInterfaceRequest {
