...
pub struct ReadVmsStopHistoryResponse {
    ...
    #[serde(rename = "VmsStopHistory", skip_serializing_if = "Option::is_none")]
    pub vms_stop_history: Option<Vec<crate::models::VmsStopHistory>>,
}

impl ReadVmsStopHistoryResponse {
    pub fn new() -> ReadVmsStopHistoryResponse {
        ReadVmsStopHistoryResponse {
            next_page_token: None,
            response_context: None,
            vms_stop_history: None,
        }
    }
}
