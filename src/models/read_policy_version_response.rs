...
pub struct ReadPolicyVersionResponse {
    #[serde(rename = "PolicyVersion", skip_serializing_if = "Option::is_none")]
    pub policy_version: Option<Box<crate::models::PolicyVersion>>,
...
impl ReadPolicyVersionResponse {
    pub fn new() -> ReadPolicyVersionResponse {
