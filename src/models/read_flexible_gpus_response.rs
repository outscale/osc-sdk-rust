...
pub struct ReadFlexibleGpusResponse {
    /// Information about one or more fGPUs.
    #[serde(rename = "FlexibleGpus", skip_serializing_if = "Option::is_none")]
    pub flexible_gpus: Option<Vec<crate::models::FlexibleGpu>>,
...
impl ReadFlexibleGpusResponse {
    pub fn new() -> ReadFlexibleGpusResponse {
