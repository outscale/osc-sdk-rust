...
pub struct FiltersKeypair {
    ...
    #[serde(rename = "KeypairIds", skip_serializing_if = "Option::is_none")]
    pub keypair_ids: Option<Vec<String>>,
    ...
    #[serde(rename = "KeypairTypes", skip_serializing_if = "Option::is_none")]
    pub keypair_types: Option<Vec<String>>,
