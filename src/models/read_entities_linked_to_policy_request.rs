...
pub struct ReadEntitiesLinkedToPolicyRequest {
    /// The type of entity linked to the policy (`ACCOUNT` \\| `USER` \\| `GROUP`) you want to get information about.
    #[serde(rename = "EntitiesType", skip_serializing_if = "Option::is_none")]
    pub entities_type: Option<Vec<EntitiesType>>,
    ...
    #[serde(rename = "PolicyOrn", skip_serializing_if = "Option::is_none")]
    pub policy_orn: Option<String>,
...
impl ReadEntitiesLinkedToPolicyRequest {
    pub fn new() -> ReadEntitiesLinkedToPolicyRequest {
...
impl Default for EntitiesType {
    fn default() -> EntitiesType {
        Self::ACCOUNT
    }
}
