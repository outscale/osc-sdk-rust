...
pub struct FiltersVmsStopHistory {
    ...
    #[serde(rename = "StopDateAfter", skip_serializing_if = "Option::is_none")]
    pub stop_date_after: Option<String>,
    ...
    #[serde(rename = "StopDateBefore", skip_serializing_if = "Option::is_none")]
    pub stop_date_before: Option<String>,
    /// The IDs of the stopped VM(s).
    #[serde(rename = "VmIds", skip_serializing_if = "Option::is_none")]
    pub vm_ids: Option<Vec<String>>,
}

impl FiltersVmsStopHistory {
    /// One or more filters.
    pub fn new() -> FiltersVmsStopHistory {
        FiltersVmsStopHistory {
            state_reasons: None,
            stop_date_after: None,
            stop_date_before: None,
            vm_ids: None,
        }
    }
}
