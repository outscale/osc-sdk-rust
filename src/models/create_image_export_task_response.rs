...
pub struct CreateImageExportTaskResponse {
    #[serde(rename = "ImageExportTask", skip_serializing_if = "Option::is_none")]
    pub image_export_task: Option<Box<crate::models::ImageExportTask>>,
...
impl CreateImageExportTaskResponse {
    pub fn new() -> CreateImageExportTaskResponse {
        CreateImageExportTaskResponse {
            image_export_task: None,
