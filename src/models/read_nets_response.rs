...
pub struct ReadNetsResponse {
    /// Information about the described Nets.
    #[serde(rename = "Nets", skip_serializing_if = "Option::is_none")]
    pub nets: Option<Vec<crate::models::Net>>,
...
impl ReadNetsResponse {
    pub fn new() -> ReadNetsResponse {
        ReadNetsResponse {
            nets: None,
