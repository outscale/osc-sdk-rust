...
pub struct ReadVpnConnectionsResponse {
    ...
    pub vpn_connections: Option<Vec<crate::models::VpnConnection>>,
}

impl ReadVpnConnectionsResponse {
    pub fn new() -> ReadVpnConnectionsResponse {
