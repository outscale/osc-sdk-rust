...
pub struct UpdateVmRequest {
    ...
    #[serde(
        rename = "ShutdownBehaviorConfiguration",
        skip_serializing_if = "Option::is_none"
    )]
    pub shutdown_behavior_configuration: Option<Box<crate::models::ShutdownBehaviorConfiguration>>,
...
impl UpdateVmRequest {
    pub fn new(vm_id: String) -> UpdateVmRequest {
        UpdateVmRequest {
            ...
            shutdown_behavior_configuration: None,
            user_data: None,
            vm_id,
