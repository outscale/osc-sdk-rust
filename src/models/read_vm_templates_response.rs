...
pub struct ReadVmTemplatesResponse {
    ...
    #[serde(rename = "VmTemplates", skip_serializing_if = "Option::is_none")]
    pub vm_templates: Option<Vec<crate::models::VmTemplate>>,
}

impl ReadVmTemplatesResponse {
    pub fn new() -> ReadVmTemplatesResponse {
