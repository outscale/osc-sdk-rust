...
pub struct VmsStopHistory {
    ...
    #[serde(rename = "StopDate", skip_serializing_if = "Option::is_none")]
...
impl VmsStopHistory {
    /// Information about the stop history of one or more VMs.
    pub fn new() -> VmsStopHistory {
        VmsStopHistory {
            state_reason: None,
            stop_date: None,
            vm_id: None,
