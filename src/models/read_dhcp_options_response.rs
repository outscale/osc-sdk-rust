...
pub struct ReadDhcpOptionsResponse {
    /// Information about one or more DHCP options sets.
    #[serde(rename = "DhcpOptionsSets", skip_serializing_if = "Option::is_none")]
    pub dhcp_options_sets: Option<Vec<crate::models::DhcpOptionsSet>>,
...
impl ReadDhcpOptionsResponse {
    pub fn new() -> ReadDhcpOptionsResponse {
        ReadDhcpOptionsResponse {
            dhcp_options_sets: None,
