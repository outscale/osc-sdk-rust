...
pub struct ReadServerCertificatesResponse {
    ...
    #[serde(rename = "ServerCertificates", skip_serializing_if = "Option::is_none")]
    pub server_certificates: Option<Vec<crate::models::ServerCertificate>>,
}

impl ReadServerCertificatesResponse {
    pub fn new() -> ReadServerCertificatesResponse {
