...
pub struct ReadUserPolicyResponse {
    /// The policy document, providing a description of the policy.
    #[serde(rename = "PolicyDocument", skip_serializing_if = "Option::is_none")]
...
impl ReadUserPolicyResponse {
    pub fn new() -> ReadUserPolicyResponse {
