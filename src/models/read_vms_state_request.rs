...
pub struct ReadVmsStateRequest {
    /// If true, includes the status of all VMs. By default or if set to false, only includes the status of running VMs.
    #[serde(rename = "AllVms", skip_serializing_if = "Option::is_none")]
    pub all_vms: Option<bool>,
    /// If true, checks whether you have the required permissions to perform the action.
    #[serde(rename = "DryRun", skip_serializing_if = "Option::is_none")]
    pub dry_run: Option<bool>,
    #[serde(rename = "Filters", skip_serializing_if = "Option::is_none")]
    pub filters: Option<Box<crate::models::FiltersVmsState>>,
...
impl ReadVmsStateRequest {
    pub fn new() -> ReadVmsStateRequest {
        ReadVmsStateRequest {
            all_vms: None,
            dry_run: None,
            filters: None,
