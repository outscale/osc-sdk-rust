...
pub struct FiltersDedicatedGroup {
    ...
    pub cpu_generations: Option<Vec<i32>>,
    /// The IDs of the dedicated groups.
    #[serde(rename = "DedicatedGroupIds", skip_serializing_if = "Option::is_none")]
    pub dedicated_group_ids: Option<Vec<String>>,
...
impl FiltersDedicatedGroup {
    /// One or more filters.
    pub fn new() -> FiltersDedicatedGroup {
        FiltersDedicatedGroup {
            cpu_generations: None,
            dedicated_group_ids: None,
            names: None,
