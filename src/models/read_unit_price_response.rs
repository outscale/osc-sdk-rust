...
pub struct ReadUnitPriceResponse {
    ...
    #[serde(rename = "UnitPriceEntry", skip_serializing_if = "Option::is_none")]
    pub unit_price_entry: Option<Box<crate::models::UnitPriceEntry>>,
}

impl ReadUnitPriceResponse {
    pub fn new() -> ReadUnitPriceResponse {
        ReadUnitPriceResponse {
            response_context: None,
            unit_price_entry: None,
        }
    }
}
