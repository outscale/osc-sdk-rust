...
pub struct ReadNatServicesResponse {
    /// Information about one or more NAT services.
    #[serde(rename = "NatServices", skip_serializing_if = "Option::is_none")]
    pub nat_services: Option<Vec<crate::models::NatService>>,
...
impl ReadNatServicesResponse {
    pub fn new() -> ReadNatServicesResponse {
