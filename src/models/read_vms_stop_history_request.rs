...
pub struct ReadVmsStopHistoryRequest {
    #[serde(rename = "Filters", skip_serializing_if = "Option::is_none")]
    pub filters: Option<Box<crate::models::FiltersVmsStopHistory>>,
...
impl ReadVmsStopHistoryRequest {
    pub fn new() -> ReadVmsStopHistoryRequest {
