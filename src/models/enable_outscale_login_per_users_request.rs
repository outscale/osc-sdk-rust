...
pub struct EnableOutscaleLoginPerUsersRequest {
...
impl EnableOutscaleLoginPerUsersRequest {
    pub fn new(user_names: Vec<String>) -> EnableOutscaleLoginPerUsersRequest {
