...
pub struct PolicyEntities {
    ...
    pub accounts: Option<Vec<crate::models::MinimalPolicy>>,
    /// The groups linked to the specified policy.
    #[serde(rename = "Groups", skip_serializing_if = "Option::is_none")]
    pub groups: Option<Vec<crate::models::MinimalPolicy>>,
    ...
    pub users: Option<Vec<crate::models::MinimalPolicy>>,
}

impl PolicyEntities {
    /// Information about the policy entities.
    pub fn new() -> PolicyEntities {
        PolicyEntities {
            accounts: None,
            groups: None,
            has_more_items: None,
